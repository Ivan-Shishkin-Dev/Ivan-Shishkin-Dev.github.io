...
const socialLinks = [
  { icon: <GmailIcon />, color: 'gray', label: 'Email', copyText: 'shishkinivan2006@gmail.com' },
  { icon: <GitHubIcon />, color: 'gray', label: 'GitHub', link: 'https://github.com/Ivan-Shishkin-Dev' },
  { icon: <LinkedInIcon />, color: 'gray', label: 'LinkedIn', link: 'https://www.linkedin.com/in/ivan-shishkin-dev' }
]
      ...
      <Section id="about" style={{ background: '#0a0a0a' }}>
        <div className="section-content">
          ...
          <p className="section-text">
            Welcome to my portfolio! I'm a passionate software engineer with experience
            in building modern web applications. I love creating clean, efficient code
